...
<a href="{{ url('/details/'.$topuser1->id) }}" style="margin:0 auto;">
    <div class="image_card_al">
        <img src="http://joeydejong12.epizy.com/img/1st.png" alt="1st" class="plaats">
    </div>
...
<a href="{{ url('/details/'.$topuser2->id) }}" style="margin:0 auto;">
    <div class="image_card_al">
        <img src="http://joeydejong12.epizy.com/img/2nd.png" alt="2nd" class="plaats">
    </div>
...
<a href="{{ url('/details/'.$topuser3->id) }}" style="margin:0 auto;">
    <div class="image_card_al">
        <img src="http://joeydejong12.epizy.com/img/3th.png" alt="3th" class="plaats">
    </div>
